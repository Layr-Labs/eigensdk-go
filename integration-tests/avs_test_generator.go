...
// func TestAvsExample[Input any, Output any](t *testing.T, config TestConfig[Input, Output]) {
...
// 	// Aggregator
// 	aggregator := createAvsAggregator(t, ethHttpUrl, ethWsUrl, config)

// 	aggErrC := aggregator.Start(ctx)

// 	// Challenger
// 	challenger := createAvsChallenger(t, ethHttpUrl, ethWsUrl, config)

// 	chErrC := challenger.Start(ctx)

// 	// Operator
// 	operator := createAvsOperator(t, ethHttpUrl, ethWsUrl, config)

// 	opErrC := operator.Start(ctx)

// 	// Task Spammer
// 	taskSpammer := createAvsTaskSpammer(t, ethHttpUrl, config)
