...
// Source: github.com/Layr-Labs/eigensdk-go/services/ecdsa/avsregistry (interfaces: AvsRegistryService)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avsregistry.go -package=mocks github.com/Layr-Labs/eigensdk-go/services/ecdsa/avsregistry AvsRegistryService
//
...
func (m *MockAvsRegistryService) GetCheckSignaturesIndices(arg0 *bind.CallOpts, arg1 uint32, arg2 []byte, arg3 []common.Address) (contractECDSAOperatorStateRetriever.ECDSAOperatorStateRetrieverCheckSignaturesIndices, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsRegistryService) GetOperatorsAvsStateAtBlock(arg0 context.Context, arg1 []byte, arg2 uint32) (map[common.Address]types.OperatorEcdsaAvsState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOperatorsAvsStateAtBlock", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[common.Address]types.OperatorEcdsaAvsState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsRegistryService) GetQuorumsAvsStateAtBlock(arg0 context.Context, arg1 []byte, arg2 uint32) (map[byte]types.QuorumEcdsaAvsState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQuorumsAvsStateAtBlock", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[byte]types.QuorumEcdsaAvsState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
