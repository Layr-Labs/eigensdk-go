...
// Source: github.com/Layr-Labs/eigensdk-go/services/bls/avsregistry (interfaces: AvsRegistryService)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avsregistry.go -package=mocks github.com/Layr-Labs/eigensdk-go/services/bls/avsregistry AvsRegistryService
//
...
func (m *MockAvsRegistryService) GetOperatorsAvsStateAtBlock(arg0 context.Context, arg1 []byte, arg2 uint32) (map[[32]byte]types.OperatorBlsAvsState, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsRegistryService) GetQuorumsAvsStateAtBlock(arg0 context.Context, arg1 []byte, arg2 uint32) (map[byte]types.QuorumBlsAvsState, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetQuorumsAvsStateAtBlock", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[byte]types.QuorumBlsAvsState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
