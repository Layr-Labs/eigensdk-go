...
set -a
source $root_dir/../../contracts/anvil/utils.sh
...
start_anvil_docker "" $anvil_dir/incredible-dot-product-anvil-state.json
sleep 1

$root_dir/tests/anvil/deploy-eigenlayer.sh
$root_dir/tests/anvil/deploy-avs.sh
$root_dir/tests/anvil/uam-permissions.sh
$root_dir/tests/anvil/create-quorum.sh
