...
```bash
   go install github.com/Layr-Labs/eigensdk-go-master/cmd/egnaddrs@latest
```

#### Install from local source
If you have git cloned eigensdk-go-master to your machine, navigate to [cmd/egnaddrs](.) directory and run
```bash
   go install
```
